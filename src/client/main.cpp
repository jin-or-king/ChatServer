...
void readTaskHandler(int clientfd)
{
    for (;;)
    {
        ...
        if (static_cast<int>(EnMsgType::ONE_CHAT_MSG) == msgtype)
        {
            cout << js["time"].get<string>() << " [" << js["id"] << "]" << js["name"].get<string>()
                 << " said: " << js["msg"].get<string>() << endl;
            continue;
        ...
        if (static_cast<int>(EnMsgType::GROUP_CHAT_MSG) == msgtype)
        {
            cout << "群消息[" << js["groupid"] << "]:" << js["time"].get<string>() << " [" << js["id"] << "]" << js["name"].get<string>()
                 << " said: " << js["msg"].get<string>() << endl;
            continue;
        ...
        if (static_cast<int>(EnMsgType::LOGIN_MSG_ACK) == msgtype)
        {
        ...
        if (static_cast<int>(EnMsgType::REG_MSG_ACK) == msgtype)
        {
            doRegResponse(js);
